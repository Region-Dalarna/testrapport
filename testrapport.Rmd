...
if(uppdatera_hemsida==TRUE){
 ...
 file.copy(from = "testrapport.html", to = "docs/index.html", overwrite = TRUE)
 file.copy(from = "testrapport.Rmd", to = "docs/index.Rmd", overwrite = TRUE)

 #ska vi ta bort html-filen i projektmappen eller ha dubbelt, både där och i docs-mappen?
#file.remove("testrapport.html")
